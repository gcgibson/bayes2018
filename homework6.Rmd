...
```{r}
print ("B0")
print (signif(mean(mod2$BUGSoutput$sims.array[,,"b0"]),3))
print (signif(quantile(mod2$BUGSoutput$sims.array[,,"b0"],c(.025,.975)),3))

print ("B1")
print (signif(mean(mod2$BUGSoutput$sims.array[,,"b1"]),3))
print (signif(quantile(mod2$BUGSoutput$sims.array[,,"b1"],c(.025,.975)),3))
```
...
print (df_p)
b0= mod2$BUGSoutput$summary["b0",][c(3,7)]
b1=mod2$BUGSoutput$summary["b1",][c(3,7)]
b2=mod2$BUGSoutput$summary["b2",][c(3,7)]
alpha1=mod2$BUGSoutput$summary["alpha.j[1]",][c(3,7)]
alpha2=mod2$BUGSoutput$summary["alpha.j[2]",][c(3,7)]
alpha3=mod2$BUGSoutput$summary["alpha.j[3]",][c(3,7)]
alpha4=mod2$BUGSoutput$summary["alpha.j[4]",][c(3,7)]
alpha5=mod2$BUGSoutput$summary["alpha.j[5]",][c(3,7)]
alpha=rbind(alpha1,alpha2,alpha3,alpha4,alpha5)

p=c()
for(i in 1:5)
{
odd=alpha[i]+b0+b1*(0.5-mean(dist100))+b2*(log(1.2)-mean(log.arsenic))
cache=exp(odd)/(1+exp(odd))
p=rbind(p,cache)
}
rownames(p)=c("group1","group2","group3","group4","group5")
round(p,digit=3)
print (p)
