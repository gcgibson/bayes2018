...
$$\theta |D \sim Beta(.2+10,.8+90)$$

$$E(\theta |D ) = .112$$

```{r}
#library(pander)
print (signif(qbeta(.05,.2+10,.8+90),3))
print (signif(qbeta(.05,.2+10,.8+90),3))
```
...
$$\theta |D \sim Beta(20+10,80+90)$$

$$E(\theta |D ) = .176$$


```{r}
print (signif(qbeta(.05,20+10,80+90),3))
print (signif(qbeta(.05,20+10,80+90),3))
```
...
for (i in 1:length(n)){
  ...
  mat[count,] <- c(n[i],tmp[1],0)
  count <- count + 1
  mat[count,] <- c(n[i],tmp[2],0)
  count <- count + 1
  mat[count,] <- c(n[i],tmp[3],0)
  count <- count + 1
